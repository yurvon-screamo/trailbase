        ...
        ? (globalThis.Object.entries(object.oauthProviders) as [string, any][]).reduce(
          (acc: { [key: string]: OAuthProviderConfig }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: OAuthProviderConfig.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
...
export const SystemJob: MessageFns<SystemJob> = {
  encode(message: SystemJob, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.timeout !== undefined && message.timeout !== 0n) {
  ...
  fromPartial<I extends Exact<DeepPartial<SystemJob>, I>>(object: I): SystemJob {
    ...
    message.timeout = (object.timeout !== undefined && object.timeout !== null) ? BigInt(object.timeout) : 0n;
    return message;
  },
};
